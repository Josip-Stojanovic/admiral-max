 ...
 *   - unit is one of: "two" (for two), "kg" (per kg), "100g", "250g", "300g", "three" (3 pieces).
 *     Word units are translated in js/i18n.js (unitTwo, unitKg, unitThree); gram units print as is.
 *
 * Transcribed on 2026-09-06 from four photos of the menu board outside the
 * restaurant, sent by Tomislav. Desserts are shown on the board only as
 * pictures, without prices, so they carry no prices here.
 */
window.ADMIRAL_MENU = [
  {
    id: "m-cold",
    ...
    items: [
      { name: { en: "Cold fish plate for two", hr: "Hladna riblja plata", de: "Kalte Fischplatte", it: "Piatto freddo di pesce" },
        desc: { en: "Salted and marinated anchovies, octopus salad, fish pâté.", hr: "Sardoni slani i marinirani, salata od hobotnice, riblja pašteta.", de: "Gesalzene und marinierte Sardellen, Oktopussalat, Fischpastete.", it: "Sardoni salati e marinati, insalata di polpo, paté di pesce." },
        price: "26", unit: "two" },
      { name: { en: "Octopus salad", hr: "Salata od hobotnice", de: "Oktopussalat", it: "Insalata di polpo" }, price: "14.50" },
      { name: { en: "Salted or marinated anchovies", hr: "Slani ili marinirani sardoni", de: "Gesalzene oder marinierte Sardellen", it: "Sardoni sotto sale o marinati" }, price: "9" },
      { name: { en: "Fish pâté", hr: "Riblja pašteta", de: "Fischpastete", it: "Paté di pesce" }, price: "9" },
      { name: { en: "Istrian prosciutto", hr: "Pršut istarski", de: "Istrischer Schinken", it: "Prosciutto istriano" }, price: "12.50", unit: "100g" },
      { name: { en: "Sheep's cheese", hr: "Ovčji sir", de: "Schafskäse", it: "Formaggio pecorino" }, price: "12", unit: "100g" },
      { name: { en: "Cheese with truffles", hr: "Sir s tartufima", de: "Käse mit Trüffeln", it: "Formaggio al tartufo" }, price: "14.50", unit: "100g" },
      { name: { en: "Beef carpaccio", hr: "Carpaccio od bifteka", de: "Carpaccio vom Rindsteak", it: "Carpaccio di manzo" }, price: "16", unit: "100g" },
      { name: { en: "Octopus carpaccio", hr: "Carpaccio od hobotnice", de: "Carpaccio vom Oktopus", it: "Carpaccio di polpo" }, price: "14.50" },
  ...
  },
  {
    ...
    items: [
      { name: { en: "Mussels in buzara", hr: "Dagnje na buzaru", de: "Miesmuscheln in Buzara-Sauce", it: "Cozze alla busara" },
        ...
        price: "13.50" },
      { name: { en: "Grilled queen scallops", hr: "Kapešante na žaru", de: "Jakobsmuscheln vom Grill", it: "Capesante alla griglia" }, price: "15", unit: "three" },
      { name: { en: "Grilled canestrelli", hr: "Kanaštrele na žaru", de: "Kanaštrele vom Grill", it: "Canestrelli alla griglia" },
        ...
        price: "14.50" },
      { name: { en: "Scampi risotto", hr: "Rižoto škampi", de: "Risotto mit Scampi", it: "Risotto con scampi" }, price: "18.50" },
  ...
  },
  {
    ...
    items: [
      { name: { en: "Fish soup", hr: "Riblja juha", de: "Fischsuppe", it: "Brodo di pesce" }, price: "7.80" },
      { name: { en: "Beef soup", hr: "Goveđa juha", de: "Rindsuppe", it: "Brodo di manzo" }, price: "5.80" },
      { name: { en: "Tomato soup", hr: "Juha od rajčice", de: "Tomatensuppe", it: "Zuppa di pomodoro" }, price: "5.80" },
      { name: { en: "Mixed salad", hr: "Miješana salata", de: "Gemischter Salat", it: "Insalata mista" }, price: "5.20" },
      ...
      { name: { en: "Chicken salad with dressing", hr: "Salata sa piletinom i dresingom", de: "Salat mit Hähnchen und Dressing", it: "Insalata con pollo e condimento" }, price: "11" }
    ]
  },
  {
    id: "m-pasta",
    ...
    items: [
      { name: { en: "Tagliatelle with scampi", hr: "Tagliatelle sa škampima", de: "Tagliatelle mit Scampi", it: "Tagliatelle con scampi" }, price: "18.50" },
      { name: { en: "Tagliatelle with truffles", hr: "Tagliatelle sa tartufima", de: "Tagliatelle mit Trüffeln", it: "Tagliatelle al tartufo" }, price: "18.50" },
      { name: { en: "Black ravioli filled with Adriatic shrimp", hr: "Crni ravioli punjeni jadranskim kozicama", de: "Schwarze Ravioli mit Adria-Garnelen gefüllt", it: "Ravioli neri ripieni di gamberi dell'Adriatico" }, price: "17.50" },
      { name: { en: "Seafood spaghetti", hr: "Špageti plodovi mora", de: "Spaghetti mit Meeresfrüchten", it: "Spaghetti ai frutti di mare" }, price: "16.50" },
      { name: { en: "Spaghetti bolognese", hr: "Špageti bolognese", de: "Spaghetti Bolognese", it: "Spaghetti alla bolognese" }, price: "12.50" }
    ]
  },
  {
    id: "m-sea",
    ...
    items: [
      { name: { en: "Fish platter for two", hr: "Riblja plata za dvoje", de: "Fischplatte für zwei", it: "Grigliata di pesce per due" },
        ...
        price: "56", unit: "two" },
      { name: { en: "Fish platter \"Cittanova\" for two", hr: "Riblja plata \"Cittanova\"", de: "Fischplatte \"Cittanova\" für zwei", it: "Piatto di pesce \"Cittanova\" per due" },
        desc: { en: "First-class fish baked in the oven with scallops, scampi, octopus and potatoes.", hr: "Riba prve klase iz pećnice s kapešantama, škampima, hobotnicom i krumpirom.", de: "Erstklassiger Fisch aus dem Ofen mit Jakobsmuscheln, Scampi, Oktopus und Kartoffeln.", it: "Pesce di prima qualità al forno con capesante, scampi, polpo e patate." },
        price: "64", unit: "two" },
      { name: { en: "First-class fish with garnish, grilled or oven-baked", hr: "Riba I. klase s prilogom, žar ili pećnica", de: "Fisch erster Klasse mit Beilage, Grill oder Ofen", it: "Pesce di prima qualità con contorno, alla griglia o al forno" },
      ...
      { name: { en: "Sea bass fillet", hr: "File brancina", de: "Wolfsbarschfilet", it: "Filetto di branzino" },
        ...
        price: "21.50" },
      { name: { en: "Scampi, grilled or in buzara", hr: "Škampi na žaru ili buzara", de: "Scampi gegrillt oder in Buzara-Sauce", it: "Scampi alla griglia o alla busara" }, price: "30" },
  ...
  },
  {
    ...
    items: [
      { name: { en: "Rib-eye steak", hr: "Rib-eye steak", de: "Rib-Eye-Steak", it: "Rib-eye steak" },
        desc: { en: "With baked potatoes and vegetables.", hr: "Pečeni krumpir s povrćem.", de: "Mit gebackenen Kartoffeln und Gemüse.", it: "Con patate al forno e verdure." },
        price: "27", unit: "300g" },
      ...
      { name: { en: "Pork medallions in truffle sauce", hr: "Svinjski medaljoni u umaku od tartufa", de: "Schweinemedaillons in Trüffelsauce", it: "Medaglioni in salsa al tartufo" },
        desc: { en: "With croquettes.", hr: "S kroketima.", de: "Mit Kroketten.", it: "Con crocchette." },
        price: "19.50" },
      { name: { en: "Meat platter for two", hr: "Mesna plata za dvoje", de: "Fleischplatte für zwei", it: "Piatto di carne per due" },
        desc: { en: "With fried potatoes.", hr: "S prženim krumpirom.", de: "Mit Bratkartoffeln.", it: "Con patate fritte." },
        price: "38", unit: "two" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: { en: "Cheesecake", hr: "Cheesecake", de: "Käsekuchen", it: "Cheesecake" } },
